    ...
    Object.defineProperty(ChartIndicator.prototype, "_afterNew", {
        ...
        value: function () {
            ...
            if (stockChart && seriesChart) {
                ...
                var chart = stockChart.panels.push(StockPanel.new(root, { wheelY: "zoomX", panX: true, panY: false, themeTags: themeTags }));
                ...
                this.series = series;
                // legend
                var legend = chart.topPlotContainer.children.insertIndex(0, StockLegend.new(root, { stockChart: this.get("stockChart") }));
